...
export default class SpawnerGui {
	...
	public async createAsync() {
		...
		await randButton.createAsync(new MRE.Vector3(0.0,0.025,-0.2),this.guiParent.id,"Pos Rand","Pos Lin",
		...
		await emitWidth.createAsync(new MRE.Vector3(-0.5,0.1,-0.5),this.guiParent.id,"width",
		...
		await emitHeight.createAsync(new MRE.Vector3(-0.5,0.1,-0.65),this.guiParent.id,"height",
		...
		await audioDistance.createAsync(new MRE.Vector3(-0.5,0.1,-0.8),this.guiParent.id,"a rng",
